(function() {
    ...
    let optionsDefinition = {
        ...
        , bitLength                 : {mandatory: true, type: 'number'}
        , nullable                  : {mandatory: true, type: 'boolean'}
        , isAutoIncrementing        : {mandatory: true, type: 'boolean'}
        , defaultValue              : {mandatory: true, type: 'string'}
        , isPrimary                 : {mandatory: true, type: 'boolean'}
        , isUnique                  : {mandatory: true, type: 'boolean'}
        , isReferenced              : {mandatory: true, type: 'boolean'}
        , isForeignKey              : {mandatory: true, type: 'boolean'}
